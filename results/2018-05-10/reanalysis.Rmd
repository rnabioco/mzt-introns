---
title: "Examine intronic signals during MZT in Drosophila embryos, reanalysis"
...
save_plot("fly-pre-mRNA-ratios.pdf", plt, base_width = 6, base_height = 4.5)
```
...
dds <- DESeqDataSetFromMatrix(intron_mat, pdata, ~mzt + strain_id)
dds <- dds[ rowSums(counts(dds)) > 50, ] 
dds_pre <- DESeq(dds)
...
What are the transcripts that have increased intronic expression, but no increases in mature?
