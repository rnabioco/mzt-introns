...
splice_windows <- generate_splice_regions("~/Projects/shared_dbases/genomes/drosophila/Drosophila_melanogaster.BDGP6.dna.toplevel.fa.fai",                   "~/Projects/shared_dbases/annotation/drosophila/Drosophila_melanogaster.BDGP6.84.gtf")
```
...
bws <- dir(file.path(data_dir, "bigwigs", "drosophila"), full.names = TRUE, pattern = ".bw")
...
bws <- dir(file.path(data_dir, "bigwigs", "zebrafish"), full.names = TRUE, pattern = ".bw")
...
ris = foreach(i = bw_info,
              ...
              .export = c("intron_metagene", 
                          "read_bigwig",
                          "splice_windows_small"))  %dopar% {
  intron_metagene(i, splice_windows_small)
                          }
